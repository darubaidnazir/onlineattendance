...
if ($checkbot == "") {
 ...
 $token = $code = rand(9999,99999);
    ...
    $email_query1 = "Select * From student where studentemail = '$email'";
    ...
    if (mysqli_num_rows($email_query_result) > 0 OR mysqli_num_rows($email_query_result1) > 0) {
      $error_msg["emailpresent"] = "Email already Registerated in One of our DataBase";
    } else {

      $newinsertquery = "INSERT INTO `teacher` (`teachername`, `teacheremail`, `phonenumber`, `password`, `confirmpassword`,`token`, `joindate`) VALUES ('$firstname', '$email', '$phonenumber', '$newpassword', '$newconfirmpassword','$code', current_timestamp())";
...
<body>
  ...
  <div class="container">
    <div class="wrapper">
      <div class="title"><span>Teacher Registration</span></div>
